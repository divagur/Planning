...
namespace Planning.DataLayer
{
    public class ShipmentDataAdapter : IDataAdaper
    {
        ...
        public string GetSaveSql(EditState editState)
        {
            ...
            {
                case EditState.New:
                    return $@"INSERT INTO {Table} (lv_id, astime_slot_id, s_date, s_comment, o_comment, gate_id, sp_condition, driver_phone, driver_fio,
                                                    ...
                                                    attorney_issued, s_in, special_time, is_add_lv,transport_company_id, transport_type_id,supplier_id) 
                                    values(
