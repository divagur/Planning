...
namespace Planning.DataLayer
{
        ...
        where T: BaseObject
    {
        ...
        public bool Save(T _instance)
        {
            ...
            /*
                        ...
                        try
                        {
                            ...
                            {
                                SqlCommand _command = new SqlCommand(_insertQuery, db);
        ...
        public bool Insert(T _instance)
        {
            if (!IsConnected || !IsConnectionStringValid())
            {
                return false;
        ...
        public bool Update(T _instance)
        {
            if (!IsConnected || !IsConnectionStringValid())
            {
                return false;
        ...
        public bool Save(List<T> _instance)
        {
            if (!IsConnected || !IsConnectionStringValid())
            {
                return false;
        ...
        public List<T> GetObjects(string Where = "")
        {
