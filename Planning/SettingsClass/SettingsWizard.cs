...
namespace Planning
{
    public partial class SettingsWizard : Form
    {
        ...
        private void SettingsWizard_Load(object sender, EventArgs e)
        {
            ...
            txtImportRowStart.Text = _settings.volumeCalcParams.ImportStartRow.ToString();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            _settings.volumeCalcParams.ImportStartRow = int.Parse(txtImportRowStart.Text);
            _settings.volumeCalcParams.ImportColVendorCode = int.Parse(txtImportColVendorCode.Text);
            _settings.volumeCalcParams.ImportColName = int.Parse(txtImportColName.Text);
            _settings.volumeCalcParams.ImportColAmount = int.Parse(txtImportColAmount.Text);
        ...
        private void txtImportRowStart_KeyPress(object sender, KeyPressEventArgs e)
        {
